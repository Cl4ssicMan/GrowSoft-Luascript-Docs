...
Q1: Why is my command not working?
- Ensure the command is registered and the name matches.

Q2: How do I handle dialog button clicks?
- Use `onPlayerDialogCallback` and check the `buttonClicked` field.

Q3: How do I add more commands?
- Define additional command data tables and register them.
